...
async def main() -> None:
    ...
    worker: Worker = Worker(
        ...
        activities=[print_source_activity, index_source_no_chunk_activity, scraping_activity, crawling_activity, save_sources_activity, fetch_sources_activity], # Liste des activités qu'est capable d'exécuter le worker
        debug_mode=True,
